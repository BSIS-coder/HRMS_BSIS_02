<?php
/**
 * Quick Setup Script - Run this to create training tables
 * Execute: php run_training_setup.php
 */

require_once 'config.php';

echo "Starting training system setup...\n";
...
try {
    ...
    ");
    echo "✓ training_courses table created\n";
    ...
    ");
    echo "✓ training_sessions table created\n";
    ...
    ");
    echo "✓ training_enrollments table created\n";
    ...
    echo "\n========================================\n";
    echo "Training system setup completed successfully!\n";
    echo "========================================\n";
    echo "\nNext steps:\n";
    echo "1. Go to employee_competencies.php to assign competencies\n";
    echo "2. Then view the evaluation report\n";
