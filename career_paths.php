            ...
            case 'add_career_path':
                try {
                    ...
                    $stmt->execute([
                        ...
                        (isset($_POST['department_id']) && $_POST['department_id'] !== '') ? (int)$_POST['department_id'] : null
                    ]);
            ...
            case 'add_career_stage':
                try {
                    ...
                    $stmt->execute([
                        ...
                        $_POST['job_role_id'],
                        $_POST['stage_order'],
                        (isset($_POST['minimum_time_in_role']) && $_POST['minimum_time_in_role'] !== '') ? (int)$_POST['minimum_time_in_role'] : null,
                        $_POST['required_skills'] ?: null,
                        $_POST['required_experience'] ?: null
                    ]);
            ...
            case 'assign_employee_path':
                try {
                    ...
                    $stmt->execute([
                        ...
                        $_POST['start_date'],
                        (isset($_POST['target_completion_date']) && $_POST['target_completion_date'] !== '') ? $_POST['target_completion_date'] : null,
                        $_POST['status']
                    ]);
...
<body>
                            ...
                            <table class="table" id="pathsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php $desc = $path['description'] ?? ''; echo htmlspecialchars(substr($desc, 0, 50)) . (strlen($desc) > 50 ? '...' : ''); ?></td>
                                        <td>
                            ...
                            <table class="table" id="stagesTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($stage['minimum_time_in_role'] ?? '') !== '' ? $stage['minimum_time_in_role'] . ' months' : 'N/A'; ?></td>
                                        <td><?php $skills = $stage['required_skills'] ?? ''; echo htmlspecialchars(substr($skills, 0, 30)) . (strlen($skills) > 30 ? '...' : ''); ?></td>
                                        <td>
                            ...
                            <table class="table" id="assignmentsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="status-badge status-<?php echo str_replace(' ', '-', strtolower($assignment['status'])); ?>">
    ...
    <script>
        ...
        function editAssignment(id, employeeId, pathId, stageId, startDate, targetDate, status) {
            ...
            document.getElementById('start_date').value = (startDate || '').toString().substr(0, 10);
            document.getElementById('target_completion_date').value = (targetDate || '').toString().substr(0, 10);
