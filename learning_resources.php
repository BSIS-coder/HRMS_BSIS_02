...
<body>
                        ...
                        <table class="table" id="resourcesTable">
                            ...
                            <tbody id="resourceTableBody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-small" onclick="editResource(<?php echo $resource['resource_id']; ?>, '<?php echo addslashes($resource['resource_name']); ?>', '<?php echo addslashes($resource['author'] ?? ''); ?>', '<?php echo addslashes($resource['resource_type']); ?>', '<?php echo addslashes($resource['resource_url'] ?? ''); ?>', '<?php echo addslashes($resource['publication_date'] ?? ''); ?>', '<?php echo addslashes($resource['duration'] ?? ''); ?>', '<?php echo addslashes($resource['description'] ?? ''); ?>', '<?php echo addslashes($resource['tags'] ?? ''); ?>')">
                                            ✏️ Edit
                                        </button>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="url" id="file_url" name="file_url" class="form-control" placeholder="https://example.com/resource.pdf">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function editResource(id, title, author, resourceType, fileUrl, publicationDate, duration, description, tags) {
            ...
            document.getElementById('resource_action').value = 'edit_resource';
