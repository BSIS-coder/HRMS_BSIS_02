<?php
// setup_training.php
// Simple script to create training management tables - run directly via browser

require_once 'config.php';

echo "<h1>Creating Training Tables...</h1>";
...
try {
    ...
    $conn->exec($sql);
    echo "<p>✓ training_courses table created</p>";
    ...
    $conn->exec($sql);
    echo "<p>✓ trainers table created</p>";
    ...
    $conn->exec($sql);
    echo "<p>✓ training_sessions table created</p>";
    
    // Create training_enrollments table (without foreign keys)
    ...
    $conn->exec($sql);
    echo "<p>✓ training_enrollments table created</p>";
    
    // Create certifications table (without foreign keys)
    ...
    $sql = "INSERT IGNORE INTO training_courses (course_id, course_name, description, category, duration, cost, status) VALUES
    ...
    $conn->exec($sql);
    echo "<p>✓ Sample training courses inserted</p>";
    
    // Insert sample trainers
    $sql = "INSERT IGNORE INTO trainers (trainer_id, first_name, last_name, email, phone, specialization, is_internal) VALUES
    ...
    $conn->exec($sql);
    echo "<p>✓ Sample trainers inserted</p>";
    
    // Insert sample training sessions
    $sql = "INSERT IGNORE INTO training_sessions (session_id, course_id, trainer_id, session_name, start_date, end_date, location, capacity, status) VALUES
    ...
    $conn->exec($sql);
    echo "<p>✓ Sample training sessions inserted</p>";
    
    echo "<h2 style='color: green;'>All training tables created successfully!</h2>";
    echo "<p><a href='employee_evaluation_form.php'>Go to Employee Evaluation Form</a></p>";
